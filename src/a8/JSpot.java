...
public class JSpot extends JPanel implements MouseListener, Spot {
	...
	private static final Color DEAD = Color.LIGHT_GRAY;
	...
	@Override
	public void setSurroundCount(int count) {
		surround_count = count;
	}
